...
//   const [isLight, setIsLight] = useState("bg-black text-white");
//   const [isOpen, setIsOpen] = useState(false);
//   return (
//     <ThemeContext.Provider value={{ isLight, setIsLight, isOpen, setIsOpen }}>
//       {/* <Toolbar /> */}

//       <div className="relative">
//         {children}
//         <div className="absolute right-0 top-[10vh] text-white">
//           <input
...
//             onClick={() => {
//               setIsOpen(!isOpen);
//               setIsLight("bg-white text-black");
//             }}
//           />
//         </div>
//       </div>
